...
It's the starting point to interact with the zenny, and every node provides a swagger API to make this interaction easier. Available endpoints:
...
# Run two nodes
$ node bin/zenny.js -p 3001 --name 1
$ node bin/zenny.js -p 3002 --name 2 --peers http://localhost:3001
...
```sh
# Cloning repository
$ git clone git@github.com:conradoqg/zenny.git
$ cd zenny
$ npm install
