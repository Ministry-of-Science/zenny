...
const TransactionAssertionError = require("../blockchain/transaction-assertion-error");
const BlockAssertionError = require("../blockchain/block-assertion-error");
  ...
  constructor(node, blockchain, operator, miner) {
    ...
    this.app.post("/operator/wallets/:walletId/transactions", (req, res) => {
      ...
      try {
        ...
        const newTransaction = operator.createTransaction(walletId, req.body.fromAddress, req.body.toAddress, req.body.amount, req.body.changeAddress || req.body.fromAddress);
